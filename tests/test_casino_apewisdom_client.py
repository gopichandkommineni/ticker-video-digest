...
from casino_dashboard.data.apewisdom_client import (
...
def test_single_page_returns_correct_mentions():
    ...
    with patch("casino_dashboard.data.apewisdom_client.urlopen", fake_urlopen):
        with patch("casino_dashboard.data.apewisdom_client.time.sleep"):
...
def test_429_retries_once_then_raises():
    ...
    with patch("casino_dashboard.data.apewisdom_client.urlopen", side_effect=exc):
        with patch("casino_dashboard.data.apewisdom_client.time.sleep"):
