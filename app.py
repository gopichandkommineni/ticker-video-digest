...
st.set_page_config(page_title="Ticker Video Digest", layout="wide")
...
tab_ticker, tab_market = st.tabs(["Ticker Digest", "Market Dashboard"])
with tab_ticker:
    _render_ticker_tab()
with tab_market:
    _render_market_tab()
...
st.caption(
    "Not investment advice. Output is aggregated commentary from public sources "
    "(YouTube, FRED, Yahoo Finance) plus model-generated synthesis."
)
